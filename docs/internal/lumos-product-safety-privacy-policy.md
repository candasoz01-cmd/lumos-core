# Lumos — Product Safety & Privacy Policy (Internal)

| Field | Value |
|-------|--------|
| **Document type** | Internal product safety / privacy policy |
| **Audience** | Internal product, legal, engineering, release ops |
| **Language** | English primary; Turkish summary at end |
| **Status** | **Positioning draft** — demo-safe; no production secrets |
| **Apple submission excerpt** | [`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md) |
| **Related** | [`app-store-review-prep.md`](../app-store-review-prep.md), [`lumos-karar-sozlesmesi.md`](../lumos-karar-sozlesmesi.md), [`drafts/BACKLOG.md`](../drafts/BACKLOG.md) (LUMOS-0005, LUMOS-0008), [`memory/public-repo-boundary.md`](../memory/public-repo-boundary.md) |
...
This sentence is the authoritative formulation. The App Store summary ([`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md)) quotes it for Apple App Review; all product copy and metadata should stay aligned with it.

Aligned with [`drafts/BACKLOG.md`](../drafts/BACKLOG.md) **LUMOS-0005** (hakem model — belirsizlik gizlenmez; nihai karar kullanıcıda) and [`lumos-karar-sozlesmesi.md`](../lumos-karar-sozlesmesi.md).

---

## 1. Purpose

This document states **what Lumos is and is not** for product safety, privacy, and App Store evaluation: data handling, user approval, AI boundaries, and UX honesty. It complements — but does not replace — the operational review checklist in [`app-store-review-prep.md`](../app-store-review-prep.md).

**Core principle:** Lumos does **not** sell the model; it delivers a **safe workflow experience**.

For a scannable Apple-facing excerpt (1–2 pages), use [`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md).
...
| **Replace human decision-making** | Lumos augments organization and suggestion; the user retains final authority (see canonical principle) |
...
Aligned with [`lumos-karar-sozlesmesi.md`](../lumos-karar-sozlesmesi.md), **LUMOS-0005** (nihai karar kullanıcıda; hakem modeli), and **LUMOS-0008** (L0 authority matrix: Read · Suggest · Execute (ruled) · Critical approval):
...
| **Honest uncertainty** | When confidence is low, Lumos states limits rather than filling gaps (LUMOS-0005) |
...
For paste-ready Review Notes and engineering spec, use [`app-store-review-prep.md`](../app-store-review-prep.md) — do not duplicate that checklist here. Scannable Apple summary: [`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md).
...
| Document | Relevance |
|----------|-----------|
| [`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md) | Apple submission excerpt (short; do not expand in place) |
...
| [`drafts/BACKLOG.md`](../drafts/BACKLOG.md) — **LUMOS-0005** | Hakem modeli — belirsizlik gizlenmez; nihai karar kullanıcıda |
...
- **Onay:** Dış yazma ve geri dönüşsüz işlemler açık kullanıcı onayı olmadan yapılmaz ([`lumos-karar-sozlesmesi.md`](../lumos-karar-sozlesmesi.md), LUMOS-0005, LUMOS-0008).
...
- **Apple özeti:** [`app-store-product-safety-privacy.md`](../app-store-product-safety-privacy.md).
