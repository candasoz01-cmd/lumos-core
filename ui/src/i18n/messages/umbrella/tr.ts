...
const umbrellaTr = {
  ...
  slack: {
    ...
    rowSlackName: "Slack",
    rowSlackNote: "Kanal özeti ve mention; tam workspace arşivi hedeflenmez",
    readsTitle: "Ne okur?",
    read1: "Politika kapsamındaki kanal mesaj özeti ve thread kimliği.",
    read2: "Mention ve bildirim bağlamı (grant kapsamında).",
    writesTitle: "Ne yazar? (onaylı)",
    write1: "Mesaj gönderme, kanala post ve reaksiyon — granüler grant + onay.",
    deletesTitle: "Silme",
    deleteBody: "Mesaj veya kanal silme nadirdir; kurumsal politika ve açık onay gerekir.",
    statusTitle: "Durum",
    statusBody:
  ...
  integrations: {
    ...
    rowSlackName: "Slack",
    rowSlackNote: "Politika kapsamındaki kanal özeti; mail kanalından ayrı",
