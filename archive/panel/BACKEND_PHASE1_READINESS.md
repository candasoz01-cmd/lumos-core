...
**Phase 2 checkpoint (panel, kalıcı):** Gerçek okuma / fallback / bridge hattı özeti / sonraki adım: `panel/PANEL_PHASE2_CHECKPOINT.md`. Config + Kimlik + Anahtar Kasası dar okuma kapsamı bu checkpoint’te kilitli.
