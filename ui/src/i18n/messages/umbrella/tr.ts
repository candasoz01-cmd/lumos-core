...
const umbrellaTr = {
  ...
  cyber: {
    ...
    scoreUnit: "/ 100 tehdit puanı",
    demoEyebrow: "GÜVENLİ GÖRSEL DEMO",
    demoTitle: "Tehdit seviyesini dene",
    demoOpen: "Demo aç",
    demoClose: "Demo kapat",
    demoRange: "Saldırı boyutu: 0–100",
    demoNote: "Bu kontrol gerçek saldırı telemetrisi değildir. Demo kapanınca sayfa güvenli varsayılan duruma döner.",
    reportEyebrow: "OLAY KAYDI",
    reportTitle: "Süre, etki ve hasar görünürlüğü",
    reportLead: "Gerçek telemetri bağlanana kadar üretim olayları gösterilmez. Demo açıldığında yalnızca açıkça işaretlenmiş örnek senaryolar görünür.",
    reportEmpty: "Aktif olay verisi yok. Lumos bir saldırı varmış gibi davranmaz.",
    reportId: "Olay",
    reportSize: "Boyut",
    reportStarted: "Başlangıç",
    reportDuration: "Çözüm süresi",
    reportImpact: "Kayıp / hasar",
    reportStatus: "Durum",
    demoTime1: "10:14 (örnek)",
    demoDuration1: "4 dk 12 sn",
    demoImpact1: "Doğrulanmış kayıp yok",
    demoTime2: "11:02 (örnek)",
    demoDuration2: "İzleniyor",
    demoImpact2: "2 hizmet etkilenmiş varsayımı",
    resolved: "Giderildi",
    ongoing: "Sürüyor",
    statusTitle: "Durum",
    statusBody: "Görsel demo hazır; gerçek olay telemetrisi henüz bağlı değil. Üretim verisi gelmeden olay veya kayıp iddiası gösterilmez.",
  ...
  integrations: {
    ...
    ecosystemTitle: "Lumos, bu sistemleri birlikte çalıştırır",
    ecosystemBody: "Önce kategori seç; logolar yalnızca açtığın kategoride görünür. Katalog kaydı canlı bağlantı anlamına gelmez.",
    categoryAi: "AI",
  ...
  metaConnections: {
    metaTitle: "Meta bağlantıları — Lumos",
    metaDescription: "Lumos WhatsApp, Instagram ve Facebook read-only bağlantı durumları.",
    eyebrow: "LUMOS · META COMMUNICATIONS",
    title: "Meta bağlantıları",
    lead: "WhatsApp, Instagram ve Facebook hesaplarının yetkilendirme ve read-only senkron durumunu tek yerde gör.",
    boundary: "Bu yüzey yalnız bağlantı ve salt-okunur metadata senkronunu yönetir. Mesaj gönderme veya yayınlama yetkisi içermez.",
    cardsAria: "Meta bağlantı durumları",
    ...
    status: {
      ...
      authorized: "Yetkilendirildi — senkron bekliyor",
      synced: "Read-only senkron doğrulandı",
      refreshed: "Yetki yenilendi",
      sessionRequired: "Lumos oturumu gerekli",
      configurationRequired: "Sunucu yapılandırması gerekli",
      unavailable: "Durum alınamadı",
      actionFailed: "İşlem doğrulanamadı",
      revokedLocal: "Yerel bağlantı kaldırıldı; Meta revoke doğrulanamadı",
    },
    connect: "Bağla",
    sync: "Read-only senkron",
    refresh: "Yenile",
    revoke: "Bağlantıyı kaldır",
    oauthAuthorized: "Yetkilendirme kaydedildi. Güncel bağlantı durumu kontrol ediliyor.",
    oauthFailed: "Yetkilendirme tamamlanamadı. Sunucu yapılandırması veya Meta izni gerekli olabilir.",
