...
| DL-C11 | 2026-06-20 | OD-010 CI doc-only sınıflandırma | **Closed** — kod yolunda CI zorunlu; doc-only tanımı [`od-010-ci-classification-decision.md`](memory/od-010-ci-classification-decision.md) | [`docs/memory/workflow-decision-alignment.md`](memory/workflow-decision-alignment.md) §8 |
---
