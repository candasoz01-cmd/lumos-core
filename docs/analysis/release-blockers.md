...
| **Blokaj seviyesi** | hard blocker |
| **Açıklama** | README L60 `docs/GITHUB_RELEASE_CHECKLIST.md` linkler; repo'da dosya bulunamadı. |
| **Kanıt** | `README.md` L60; glob araması 0 eşleşme |
| **30 gün içinde kapanış koşulu** | Checklist dosyası oluşturulur veya README referansı kaldırılır/güncellenir; release süreci dokümante edilir. |
| **Bağımlılıklar** | RB-08 |
