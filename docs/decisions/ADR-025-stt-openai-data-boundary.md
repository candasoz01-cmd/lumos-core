...
| Alan | Değer |
|------|-------|
| Karar durumu | **Accepted (2026-08-19); model geçişi 2026-09-14** — kurucu; dokümantasyon her maddeyi doğruladı |
...
6. Model yalnız `OPENAI_MODEL_STT` (`gpt-transcribe`). Sohbet ve cyber env'lerine düşülmez.
...
## 2026-09-14 model geçişi

OpenAI'nin resmî geçiş rehberi doğrultusunda batch STT modeli
`gpt-transcribe` olarak sabitlendi. Realtime transkripsiyonun hedefi
`gpt-live-transcribe`dır; bu yol Meet-sesi veri sınırının dışında kalmaya ve
ayrı güvenlik/izin kapılarına tabi olmaya devam eder. Eski model adlarının
kaldırılması mevcut veri yerleşimi ve açık onay hükümlerini değiştirmez.
