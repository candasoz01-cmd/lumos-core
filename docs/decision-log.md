...
| DL-C10 | 2026-06-20 | Prod smoke (A3) | **`approved-for-implementation`** — read-only HTTPS `welockai.com/panel`; `ui/e2e/smoke-prod.mjs`; `workflow_dispatch` only | [`docs/memory/od-prod-smoke-decision.md`](memory/od-prod-smoke-decision.md) |
