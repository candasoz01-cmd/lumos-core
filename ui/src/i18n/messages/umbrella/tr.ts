...
const umbrellaTr = {
  ...
  lab: {
    eyebrow: "LUMOS · LAB", title: "Merakın güvenli çalışma alanı",
    lead: "Lab; kuantum hazırlığı, yapay zekâ değerlendirmeleri ve yeni etkileşim fikirlerinin ürün vaadine dönüşmeden önce ölçüldüğü deneysel alandır.",
    visual: "Deneyler ayrı etiketlenir; sonuç, kaynak ve sınırlar görünür kalır.",
    quantumTitle: "Kuantum", quantumBody: "Hazırlık ölçümü ve güvenli deneyler; abartılı gelecek vaadi yok.",
    aiTitle: "AI karşılaştırma", aiBody: "Kalite, maliyet, hız ve mahremiyet dengesi; sağlayıcı üstünlüğü dayatılmaz.",
    humanTitle: "İnsan denetimi", humanBody: "Deney sonucu öneridir; kritik karar kullanıcıda kalır.",
    panelCta: "Panelde incele", educationCta: "Nasıl çalıştığını öğren",
  },
  education: {
