...
| — | [`od-panel-retirement-option-c-decision.md`](od-panel-retirement-option-c-decision.md) | Panel statik emekliliği (Seçenek C) | Statik legacy panel arşivi ve docs kaydı hizalı mı? | medium | **closed (ops)** | DL-C09 **(a)** docs (#321); fiziksel **(b)** #320; `panel/scripts/` canlı. Prod smoke **(c)** DL-C10. |
