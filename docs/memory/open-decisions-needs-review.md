...
| OD-027 | project-map-runtime-entrypoints.md | packages/kando_* geçişi | `packages/kando_*` → `src/` geçiş takvimi ve kesme kriterleri ne? | high | **approved-for-implementation** | Karar: [`kando-packages-transition-decision.md`](kando-packages-transition-decision.md) — **Seçenek C (Hibrit)**. Faz 3 keşif: [`kando-packages-faz3-keşif-raporu.md`](kando-packages-faz3-keşif-raporu.md). **Slice 3a `implementation-complete`** (PR #313, DL-A17): web kalıntısı + ölü `lumos_runtime` aynası kaldırıldı. **Bekleyen:** Slice 3b ayna paket arşivi, Faz 4 cutover. |
...
Son güncelleme: 2026-06-20 (OD-027 Slice 3a **implementation-complete** — PR #313)
