...
const umbrellaEn: typeof umbrellaTr = {
  ...
  cyber: {
    ...
    scoreUnit: "/ 100 threat score",
    demoEyebrow: "SAFE VISUAL DEMO",
    demoTitle: "Try the threat level",
    demoOpen: "Open demo",
    demoClose: "Close demo",
    demoRange: "Attack scale: 0–100",
    demoNote: "This control is not real attack telemetry. Closing the demo restores the safe default state.",
    reportEyebrow: "INCIDENT LOG",
    reportTitle: "Time, impact, and damage visibility",
    reportLead: "Production incidents are not shown until real telemetry is connected. The demo reveals only clearly marked sample scenarios.",
    reportEmpty: "No active incident data. Lumos does not pretend an attack exists.",
    reportId: "Incident",
    reportSize: "Scale",
    reportStarted: "Started",
    reportDuration: "Mitigation time",
    reportImpact: "Loss / damage",
    reportStatus: "Status",
    demoTime1: "10:14 (sample)",
    demoDuration1: "4 min 12 sec",
    demoImpact1: "No verified loss",
    demoTime2: "11:02 (sample)",
    demoDuration2: "Monitoring",
    demoImpact2: "Assumption: 2 services affected",
    resolved: "Resolved",
    ongoing: "Ongoing",
    statusTitle: "Status",
    statusBody: "The visual demo is ready; real incident telemetry is not connected yet. No incident or loss claim is shown without production data.",
  ...
  integrations: {
    ...
    ecosystemTitle: "Lumos runs these systems together",
    ecosystemBody: "Pick a category first; logos only appear once you open it. A catalog entry does not mean a live connection.",
    categoryAi: "AI",
  ...
  metaConnections: {
    metaTitle: "Meta connections — Lumos",
    metaDescription: "Lumos read-only connection status for WhatsApp, Instagram, and Facebook.",
    eyebrow: "LUMOS · META COMMUNICATIONS",
    title: "Meta connections",
    lead: "See authorization and read-only sync status for WhatsApp, Instagram, and Facebook accounts in one place.",
    boundary: "This surface only manages connections and read-only metadata sync. It does not include message sending or publishing authority.",
    cardsAria: "Meta connection statuses",
    ...
    status: {
      ...
      authorized: "Authorized — sync pending",
      synced: "Read-only sync verified",
      refreshed: "Authorization refreshed",
      sessionRequired: "Lumos session required",
      configurationRequired: "Server configuration required",
      unavailable: "Status unavailable",
      actionFailed: "Action could not be verified",
      revokedLocal: "Local connection removed; Meta revoke was not verified",
    },
    connect: "Connect",
    sync: "Read-only sync",
    refresh: "Refresh",
    revoke: "Remove connection",
    oauthAuthorized: "Authorization was saved. Current connection status is being checked.",
    oauthFailed: "Authorization did not complete. Server configuration or Meta permission may be required.",
  ...
  integrationGuide: {
    ...
    afterTitle: "After Lumos",
    afterBody: "The connection, scope, and next step appear in one place. Lumos summarizes, but never presses an external-action button before you do.",
