...
| DL-E08 | 2026-09-10 | Agent Wall görev rolü ilkesi | Sabit «Claude denetçi / Cursor uygulayıcı» yok; roller görev bazlıdır. Bu ilke manuel koordinasyonda geçerlidir. Wall atama yetkisi, checkpoint/kurtarma ve denetçi bağımsızlığı **tasarım bekliyor**; kod yetkisi verilmedi, STOP LIST sürüyor. | OD-064, [`ROADMAP.md`](ROADMAP.md) |
