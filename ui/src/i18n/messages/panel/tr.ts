...
const panelModules = {
  ...
  tasks: {
    ...
    detail: {
      ...
      dlSource: "Kaynak",
      dlAccepted: "Kabul",
      dlResultFile: "Sonuç dosyası",
      dlExecFile: "Çalıştırma dosyası",
      dlBridgeTime: "İletim zamanı",
      yes: "Evet",
      no: "Hayır",
      bridgeLastPrefix: "Son iletim: ",
      bridgeNotYet: "Henüz iletilmedi",
      bridgeSentSuffix: " · iletildi",
    ...
    plan: {
      ...
      notPending: "Kök neden analizi henüz yapılmadı (beklemede).",
      alanGorevler: "Görevler",
      alanDosyalar: "Dosyalar",
      alanIletim: "İletim",
      defaultTespit: "Plan hazır; işlem yok.",
      defaultCozum: "Listeden görevi aç ve bak.",
      defaultOnay: "Onay gerekir; plan onayı iletim veya kod çalıştırmaz.",
      defaultRiskOrta: "Orta",
      dlStatus: "Durum",
      dlRisk: "Risk",
      dlAlan: "Alan",
      dlSonrakiAdim: "Sonraki adım",
      dlNot: "Not",
      dlTur: "Tür",
      dlSirada: "Sırada",
      lowRiskStatus: "Plan hazırlandı, işlem yapılmadı.",
      lowRiskSonraki: "Görevi listede açıp detayları kontrol et.",
      lowRiskNot: "Kod, iletim veya terminal çalıştırılmadı.",
      pendingApproval: "Plan hazır; onay bekleniyor.",
      approvalSaved: "Onay kaydedildi",
    },
    hints: {
...
const panelShell = {
  ...
  infra: {
    ...
    leakDevice: "cihaz",
    leakConnection: "bağlantı",
    leakTask: "görev",
    leakControlledFile: "kontrollü dosya",
    leakStatus: "durum",
    leakHealth: "sağlık",
    leakChat: "sohbet",
