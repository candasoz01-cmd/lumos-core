...
| 5 | Kullanıcı platform ajanıyla (GitHub / iOS / Drive) **doğrudan konuşmaz**; Lumos mevcut claim + iş paketi ile iletir, kanıtı kendi sohbetinden sunar. | PR-006 — [`docs/product-rules.md`](../product-rules.md) |
