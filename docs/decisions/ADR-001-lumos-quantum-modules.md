...
| Panel kuantum sekmesi | Statik kartlar + readiness banner; panel sunucusu `GET /quantum-readiness` live fetch (#469) ile salt okunur JSON; canlı yükte `generated_at`, `evidenced_findings`, `entropy_lab` (#480); fetch başarısızsa docs-only mock |
