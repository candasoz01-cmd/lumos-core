...
const panelModules = {
  chat: {
    ...
    compose: {
      ...
      voiceTitleSupported: "Sesle yaz — kısa kaydı sunucu köprüsü üzerinden metne çevirir",
      voiceAriaSupported: "Sesle yaz; başlatmak ve bitirmek için dokunun",
      ...
      voiceHints: {
        ...
        recording: "Dinliyorum… Bitirmek için tekrar dokunun.",
        transcribing: "Ses metne çevriliyor…",
        added: "Metin yazı alanına eklendi; göndermek için siz onaylayın.",
        noSpeech: "Konuşma algılanmadı.",
        micUnavailable: "Mikrofon kullanılamıyor.",
        micDenied: "Mikrofon izni verilmedi.",
        failed: "Sesli giriş başarısız oldu.",
        startFailed: "Ses kaydı başlatılamadı. Tekrar deneyin.",
      },
    },
    tts: {
      speak: "Sesli oku",
  ...
  quantum: {
    ...
    live: {
      ...
      longLivedTitle: "Uzun ömürlü veri",
      longLivedClassCol: "Sınıf",
      longLivedRetentionCol: "Saklama",
      longLivedCryptoCol: "Şifreleme",
      longLivedHndlCol: "HNDL risk",
      longLivedEvidenceCol: "Kanıt",
      hardDepsTitle: "Zor değişen bağımlılıklar",
      migrationPlanTitle: "Önceliklendirilmiş geçiş planı",
      migrationPlanNote: "Salt okunur öneri — otomatik migrasyon yok.",
      planPriorityCol: "Öncelik",
      planActionCol: "Eylem",
      planTargetCol: "Hedef",
      planStatusCol: "Durum",
      rowEmpty: "—",
...
const panelShell = {
  ...
  infra: {
    ...
    prodErrors: {
      write_failed: "Dosya yazılamadı.",
      path_outside_sandbox: "İzin verilen alanın dışında.",
      read_failed: "Dosya okunamadı.",
      file_not_found: "Dosya bulunamadı.",
      create_failed: "Görev kaydedilemedi.",
      complete_failed: "Görev tamamlanamadı.",
      delete_failed: "Görev silinemedi.",
      restore_failed: "Görev geri alınamadı.",
      confirmation_required: "Bu işlem için onay gerekli.",
      confirmation_expired: "Onay süresi doldu. Lütfen tekrar deneyin.",
      scope_mismatch: "Onay bu işlemle eşleşmiyor.",
      command_not_allowed: "Bu işlem şu an kullanılamıyor.",
      unauthorized: "Bağlantı doğrulanamadı.",
      network_error: "Sunucuya ulaşılamadı.",
      server_error: "İşlem geçici olarak tamamlanamadı.",
    ...
    confirmation: {
      ...
      actions: {
        ...
        restore_task: "Görevi geri al",
        write_local: "Görev dosyasını değiştir",
        share_task_board: "Görev listesini ajanla paylaş",
      },
      effects: {
        local_task_create: "Yerel listeye görev ekler.",
        local_task_complete: "Görevi tamamlandı olarak işaretler.",
        local_task_soft_delete: "Görevi çöpe taşır.",
        local_task_restore: "Görevi çöpten geri yükler.",
        agent_read_task_board:
          "Görev tahtanızın içeriğini bu oturum boyunca ajanın okumasına açar.",
      },
    },
    webmcp: {
      consentOff: "Ajan paylaşımı: kapalı — görev listesi ajanlara verilmiyor.",
      consentOn: "Ajan paylaşımı: açık (bu oturum) — görev listesi ajanlara okunabilir.",
      consentRevoke: "İzni geri al",
      consentTarget: "Görev tahtası",
      fieldTitle: "Başlık",
      fieldPriority: "Öncelik",
      fieldWhen: "Zaman",
      fieldStatus: "Durum",
      fieldStatusChange: "Durum değişikliği",
      fieldTask: "Görev",
      fieldTaskRef: "Eşleşen referans",
      fieldSource: "Kaynak",
      fieldShared: "Paylaşılan alanlar",
      fieldScope: "Kapsam",
      fieldRevoke: "Geri alma",
      valueUnsetPrefix: "belirtilmedi",
      valueDefaultPrefix: "varsayılan",
      valueNoSchedule: "zaman planlanmıyor",
      valueUnchanged: "değişmiyor",
      valueMatchedByTitle: "başlıkla eşleşti",
      valueAgentSource: "Ajan · WebMCP",
      valueSharedFields: "Görev başlığı, öncelik, durum ve zaman notu",
      valueScopeSession: "Yalnızca bu tarayıcı oturumu (sekme kapanınca sona erer)",
      valueRevokeHere: "Görevler modülündeki “İzni geri al” düğmesi",
      priorityLow: "düşük",
      priorityNormal: "orta",
      priorityHigh: "yüksek",
