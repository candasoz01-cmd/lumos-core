...
| DL-E04 | 2026-07-13 | Ticari birimler, Lumos Dünya ve ülke entegrasyonu | Lumos Bank/Sepet/POS ayrı sorumluluk alanları; Lumos Dünya küresel yüzey; eski Lumos Devlet adı kaldırıldı; ülke bağlantısı markasız private/sözleşmeli entegrasyon katmanı. Canlı ödeme ve ülke sistemi bağlantısı bekliyor | OD-060, [ADR-015](decisions/ADR-015-regulated-service-entity-boundaries.md), [`lumos-institutional-service-foundation.md`](analysis/lumos-institutional-service-foundation.md), `candasoz01-cmd/Lumos` #102/#103 |
