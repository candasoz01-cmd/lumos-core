...
const umbrellaEn: typeof umbrellaTr = {
  ...
  lab: {
    eyebrow: "LUMOS · LAB", title: "A safe workspace for curiosity",
    lead: "Lab is the experimental space where quantum readiness, AI evaluations, and new interaction ideas are measured before becoming product claims.",
    visual: "Experiments are clearly labeled; results, sources, and limits remain visible.",
    quantumTitle: "Quantum", quantumBody: "Readiness measurement and safe experiments without exaggerated future claims.",
    aiTitle: "AI comparison", aiBody: "Balance quality, cost, speed, and privacy without declaring one provider superior.",
    humanTitle: "Human oversight", humanBody: "Experiment results are suggestions; critical decisions stay with the user.",
    panelCta: "Inspect in panel", educationCta: "Learn how it works",
  },
  education: {
