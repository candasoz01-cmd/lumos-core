...
merge yasağı değil. Bu CheckRun GitHub required check **yapılmaz**; o,
insan onaylı hariç PR’ı da fiziksel kilitler. Fiziksel kilit ayrı
`merge-authority` modeli ister. PR gövdesindeki “standing hattı yok”
cümlesi tek başına otorite değildir. Listelenmeyen yol `eligible` değildir.
Canlı ihlal: `#777` / [TD-20](docs/TECHNICAL_DEBT.md).
